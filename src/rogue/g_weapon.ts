...
import { type Edict, type GTraceT, SolidT, SVF_DAMAGEABLE, SVF_DEADMONSTER, SVF_MONSTER, SVF_NOCLIENT } from "./game";
...
// Matches the per-file cvarNum() idiom used throughout this tree (e.g.
// m_soldier.ts) -- CvarT.value with a null-cvar fallback of 0.
...
// ==========================================================================
//
// RE-RELEASE CONTENT PORT -- the xatrix projectile helpers and their
// monster_fire_* wrappers, copied verbatim (comments included) from our
// sibling src/game/g_weapon.ts. They back the re-release monsters the maps
// this module now hosts place: m_soldier.ts's ripper/hypergun/lasergun
// soldier variants, m_chick.ts's heat-seeking chick variant, m_guncmdr.ts's
// gunner commander, m_gladb.ts's beta gladiator and m_fixbot.ts's welding
// laser. Nothing in Ground Zero's own 1998-era content calls any of them.
//
// As in src/game, the monster_fire_* wrappers live here next to the fire_*
// helpers they wrap rather than in g_monster.ts.
//
// ==========================================================================
