...
// -------------------------------------------------------------------------
// Savegame function registry -- every think/touch/pain/die callback this
// file installs on an edict, so a save taken while a sphere is in flight
// restores the real function instead of null (see g_save.ts's
// registerSaveFunction name registry).
// -------------------------------------------------------------------------

import { registerSaveFunction } from "./g_save";

registerSaveFunction("g_sphere:sphere_think_explode", sphere_think_explode);
registerSaveFunction("g_sphere:sphere_explode", sphere_explode);
registerSaveFunction("g_sphere:sphere_if_idle_die", sphere_if_idle_die);
registerSaveFunction("g_sphere:sphere_fly", sphere_fly);
registerSaveFunction("g_sphere:sphere_touch", sphere_touch);
registerSaveFunction("g_sphere:vengeance_touch", vengeance_touch);
registerSaveFunction("g_sphere:hunter_touch", hunter_touch);
registerSaveFunction("g_sphere:body_gib", body_gib);
registerSaveFunction("g_sphere:hunter_pain", hunter_pain);
registerSaveFunction("g_sphere:defender_pain", defender_pain);
registerSaveFunction("g_sphere:vengeance_pain", vengeance_pain);
registerSaveFunction("g_sphere:defender_think", defender_think);
registerSaveFunction("g_sphere:hunter_think", hunter_think);
registerSaveFunction("g_sphere:vengeance_think", vengeance_think);
