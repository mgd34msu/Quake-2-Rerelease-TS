// g_newtarg.c (rogue) + g_target.c's "RAFAEL 15-APR-98" delta (xatrix)
//
// Mission-pack-only target entities ported into the classic module so
// classic can spawn the re-release maps that place them:
//   - target_steam / target_anger / target_killplayers / target_blacklight /
//     target_orb come from src/rogue/g_newtarg.ts.
//   - target_mal_laser comes from src/xatrix/g_target.ts (a small delta on
//     top of vanilla's own target_laser, which already lives in this
//     module's g_target.ts -- target_mal_laser reuses that file's
//     `target_laser_think` rather than duplicating it).
//
// Faithful, line-by-line ports; see each section for source file and any
// deviation notes.

import { VectorClear, VectorMA, VectorNormalize, VectorSet, VectorSubtract, vec3, vec3_origin } from "../shared/math";
import {
  EF_SPHERETRANS,
  EF_TRACKER,
  EF_TRACKERTRAIL,
...
//==========================================================
// target_steam -- src/rogue/g_newtarg.ts
//==========================================================
...
//==========================================================
// target_anger -- src/rogue/g_newtarg.ts
//==========================================================
...
//==========================================================
// target_killplayers -- src/rogue/g_newtarg.ts
//==========================================================
...
//==========================================================
// target_blacklight / target_orb -- src/rogue/g_newtarg.ts
//==========================================================
...
// -------------------------------------------------------------------------
registerSaveFunction("g_newtarg:use_target_steam", use_target_steam);
registerSaveFunction("g_newtarg:target_steam_start", target_steam_start);
registerSaveFunction("g_newtarg:target_anger_use", target_anger_use);
registerSaveFunction("g_newtarg:target_killplayers_use", target_killplayers_use);
registerSaveFunction("g_newtarg:blacklight_think", blacklight_think);
registerSaveFunction("g_newtarg:orb_think", orb_think);
