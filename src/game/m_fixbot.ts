...
// monster_dabeam lives in g_weapon.ts, not g_monster.ts, in this port: see
// g_weapon.ts's "xatrix additions" header comment for why (g_monster.ts is
// owned by another agent and on this port's do-not-edit list).
import { monster_dabeam } from "./g_weapon";
