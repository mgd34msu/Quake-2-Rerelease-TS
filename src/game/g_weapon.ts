...
// Matches the per-file cvarNum() idiom used throughout src/game/ (e.g.
...
// ==========================================================================
//
// xatrix additions -- ported from xatrix/g_weapon.c (`// RAFAEL` blocks) and
// xatrix/g_monster.c's matching monster_fire_* wrappers. These support the
// XATRIX MONSTERS slice (m_soldierh.ts's ripper/hyperblaster/lasergun
// soldier variants, m_chick.ts's heat-seeking chick variant, and
// m_fixbot.ts's laser). Not present in baseq2's g_weapon.c/g_monster.c.
//
// g_monster.ts is owned by another agent and is on this port's do-not-edit
// list, so the monster_fire_* wrappers that normally live alongside
// monster_fire_blaster/monster_fire_rocket/etc. in g_monster.ts are kept
// here instead, next to the fire_* helpers they wrap.
//
// ==========================================================================
